...
public class VerbWordRef_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "VerbWordRef", new SNodePointer("r:7061a567-a3c0-4126-b0e7-6588543d98ff(dictionary.editor)", "6937960931239808626")));
    try {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new TMP_Reference_vexx3i_a0());
      result.add(new TMP_Group_vexx3i_b0());
    }
    return result;
  }

  public class TMP_Reference_vexx3i_a0 extends ReferenceMenuTransformationMenuPart {
    @NotNull
    @Override
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      ...
      try {
        ...
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:7061a567-a3c0-4126-b0e7-6588543d98ff(dictionary.editor)", "6937960931239808629")));
  ...
  public class TMP_Group_vexx3i_b0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:7061a567-a3c0-4126-b0e7-6588543d98ff(dictionary.editor)", "6937960931239808630")));
      try {
        return super.createItems(context);
      } finally {
        context.getEditorMenuTrace().popTraceInfo();
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new TMP_Action_vexx3i_a1a(), new TMP_Action_vexx3i_b1a());
    }
    private class TMP_Action_vexx3i_a1a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        ...
        context.getEditorMenuTrace().pushTraceInfo();
        try {
          context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:7061a567-a3c0-4126-b0e7-6588543d98ff(dictionary.editor)", "6937960931239808643")));
      ...
      private class Item extends ActionItemBase implements SubstituteCompletionActionItem {
        ...
        public void execute(@NotNull String pattern) {
          SNode newWord = createVerbWord_vexx3i_a0a0a0b0(pattern);
          ListSequence.fromList(SLinkOperations.getChildren(wordStore, LINKS.verbs$44$I)).addElement(newWord);
        ...
        public boolean canExecute(@NotNull final String pattern) {
          return (ListSequence.fromList(SLinkOperations.getChildren(wordStore, LINKS.verbs$44$I)).findFirst(new IWhereFilter<SNode>() {
    ...
    private class TMP_Action_vexx3i_b1a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        Item item = new Item(context);
        String description;
        ...
        context.getEditorMenuTrace().pushTraceInfo();
        try {
          context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:7061a567-a3c0-4126-b0e7-6588543d98ff(dictionary.editor)", "6937960931239808699")));
          item.setTraceInfo(context.getEditorMenuTrace().getTraceInfo());
        } finally {
          context.getEditorMenuTrace().popTraceInfo();
        }
      ...
      private class Item extends ActionItemBase implements SubstituteCompletionActionItem {
        ...
        @Override
        public void execute(@NotNull String pattern) {
          SNode newWord = createVerbWord_vexx3i_a0a0a1b0(pattern);
          ListSequence.fromList(SLinkOperations.getChildren(wordStore, LINKS.verbs$44$I)).addElement(newWord);
          SLinkOperations.setTarget(_context.getNode(), LINKS.originalWord$3zic, newWord);
        }
  ...
  private static SNode createVerbWord_vexx3i_a0a0a0b0(String p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.VerbWord$rz);
    n0.setProperty(PROPS.name$MnvL, p0);
    return n0.getResult();
  }
  private static SNode createVerbWord_vexx3i_a0a0a1b0(String p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.VerbWord$rz);
    n0.setProperty(PROPS.name$MnvL, p0);
    return n0.getResult();
  }
